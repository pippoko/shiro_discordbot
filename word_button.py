...
class WordButtonView(discord.ui.View):
  ...
  @discord.ui.buttom(label="単語を表示", style=discord.ButtonStyle.primary, custom_id="word_button")
  async def send_word(self, interaction: discord.Interaction, button: discord.ui.Button):
    fixed_words = ["ヴィネットイラスト", "デフォルメ", "サテン生地", "フリル", "アオリ", "フカン", "レザー", "水面", "日差し", "レンガ", "街角", "鏡", "バラ", "着物", "背中", "横顔", "ハグ", "髪を耳にかける", "ストッキング", "プリーツスカート"]
  ...
  await interaction.response.send_message(
    f"{interaction.user.mention} あなたへのお題は **{chosen}** です！\n資料をたっぷり見て描いて、できたらhttps://discord.com/channels/1292757949608886353/1293199504459436134 にあげてみてね！",
    ephemeral=True
  )
